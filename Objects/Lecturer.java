...
public class Lecturer extends JFrame implements ActionListener {
    ...
    public Lecturer() {
        ...
        titleLabel = new JLabel("Lecturer Login Page");
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == loginButton) {
            ...
            try {
                ...
                PreparedStatement stmt = conn.prepareStatement("SELECT password FROM lecturer WHERE lecId = ?");
                ...
                if (rs.next()) {
                    ...
                    if (password.equals(storedPassword)) {
                        ...
                        lecturerH.tcView(Integer.parseInt(username));
                        dispose();
                    } else {
